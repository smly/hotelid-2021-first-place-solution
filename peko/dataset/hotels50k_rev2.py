...
class Hotel50kTrainDataset(Dataset):
    ...
    def covnert_to_path_list(self, df_train):
        return [
            "data/input/external/Hotels-50K/hotels50k_s1024_rev2/{}/{}/{}/{}/{}.jpg".format(
...
def get_hotel50k_dataset():
    with open("data/input/external/Hotels-50K/hotels50k_s1024_rev2.pkl", "rb") as f:
        data = pickle.load(f)
...
def get_dataloaders(train_transform, test_transform, params, is_debug=False):
    ...
    dataloaders["train"] = DataLoader(
        dataset=ds_trn,
        sampler=SequentialSampler(ds_trn) if is_debug else RandomSampler(ds_trn),
