...
class HotelV2RotationFixedDataset(Dataset):
    def __init__(self,
                 dataframe_filepath="data/working/feats/v110_hidv2_hotelidv2.csv",
                 rotation_fixed_filepath="data/working/v80_rotation_hotelid_train_images.csv",
                 transform=None,
                 size_template=None,
...
def train_dataloaders(
    ...
    ds_trn = HotelidV2(transform=train_transform, img_dir=img_dir)
    dataloaders = {}
...
def index_dataloader(
    ...
    ds_trn = HotelidV2(transform=index_transform, img_dir=img_dir)
    return DataLoader(
        dataset=ds_trn,
        sampler=RandomSampler(ds_trn),
