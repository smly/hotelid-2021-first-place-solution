...
class SwinTransformerEncoderArcfaceModel(nn.Module):

    def __init__(self, n_classes=7770, model_name="swin_large_patch4_window7_224",
                 margin=0.3, scale=30,
                 pretrained=None, loss_kwargs=None):
        super(SwinTransformerEncoderArcfaceModel, self).__init__()
