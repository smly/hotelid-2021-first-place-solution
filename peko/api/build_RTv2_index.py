...
from peko.competition import index_RFv2_dataloader
...
def main(args: argparse.Namespace):
    ...
    dataloaders = {}
    dataloaders["index"] = index_RFv2_dataloader(
        "data/working/feats/v110_hidv2_hotelidv2.csv",
    ...
    if args.resolution:
        feature_path = str(Path(storage_dir) / (
            f"{conf.name}_epoch{epoch:d}_r{input_size}_RFv2_index.h5"))
